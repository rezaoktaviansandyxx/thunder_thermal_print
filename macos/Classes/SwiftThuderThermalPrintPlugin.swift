...
public class SwiftThuderThermalPrintPlugin: NSObject, FlutterPlugin {

    // MARK: - Constants

    private let methodChannelName = "id.thunderlab.thuder_thermal_print"
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = SwiftThuderThermalPrintPlugin()
    ...
    private func startBleScan(manager: CBCentralManager) {
        ...
        let services: [CBUUID]? = [SwiftThuderThermalPrintPlugin.blePrinterServiceUUID]
...
extension SwiftThuderThermalPrintPlugin: CBCentralManagerDelegate {
    ...
    public func centralManager(_ central: CBCentralManager,
        ...
        // Discover services
        peripheral.discoverServices([SwiftThuderThermalPrintPlugin.blePrinterServiceUUID])
    }
...
extension SwiftThuderThermalPrintPlugin: CBPeripheralDelegate {

    public func peripheral(_ peripheral: CBPeripheral,
                            didDiscoverServices error: Error?) {
        guard let services = peripheral.services else { return }
        for service in services {
            if service.uuid == SwiftThuderThermalPrintPlugin.blePrinterServiceUUID {
                peripheral.discoverCharacteristics(
                    [SwiftThuderThermalPrintPlugin.bleWriteCharacteristicUUID,
                     SwiftThuderThermalPrintPlugin.bleReadCharacteristicUUID],
                    for: service
                )
            }
        }
    ...
    public func peripheral(_ peripheral: CBPeripheral,
        ...
        for characteristic in characteristics {
            if characteristic.uuid == SwiftThuderThermalPrintPlugin.bleWriteCharacteristicUUID {
                writeCharacteristic = characteristic
            }
            if characteristic.uuid == SwiftThuderThermalPrintPlugin.bleReadCharacteristicUUID {
