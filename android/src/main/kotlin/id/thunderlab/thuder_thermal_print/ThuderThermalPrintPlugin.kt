package id.thunderlab.thuder_thermal_print
...
import id.thunderlab.thuder_thermal_print.bluetooth.BluetoothPrinterManager
import id.thunderlab.thuder_thermal_print.ble.BlePrinterManager
import id.thunderlab.thuder_thermal_print.usb.UsbPrinterManager
import id.thunderlab.thuder_thermal_print.network.NetworkPrinterManager
...
class ThuderThermalPrintPlugin : FlutterPlugin, ActivityAware, MethodCallHandler,
    RequestPermissionsResultListener {

    companion object {
        private const val TAG = "ThuderThermalPrint"
        private const val CHANNEL_NAME = "id.thunderlab.thuder_thermal_print"
        private const val EVENT_CONNECTION_STATE = "id.thunderlab.thuder_thermal_print/connection_state"
        private const val EVENT_DEVICE_EVENTS = "id.thunderlab.thuder_thermal_print/device_events"
    ...
    private fun handlePrintText(call: MethodCall, result: Result) {
        ...
        val encoder = id.thunderlab.thuder_thermal_print.utils.EscPosEncoder()
