#include "thuder_thermal_print_plugin.h"
...
// Plugin class
// ---------------------------------------------------------------------------
class ThuderThermalPrintPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows* registrar) {
    ...
    auto plugin = std::make_unique<ThuderThermalPrintPlugin>();
  ...
  ThuderThermalPrintPlugin() = default;

  ~ThuderThermalPrintPlugin() override {
      std::lock_guard<std::mutex> lock(g_connection.mutex);
      g_connection.Reset();
...
// ---------------------------------------------------------------------------
void ThuderThermalPrintPluginCApiRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  ThuderThermalPrintPlugin::RegisterWithRegistrar(
