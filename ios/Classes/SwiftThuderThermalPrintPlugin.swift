...
public class SwiftThuderThermalPrintPlugin: NSObject, FlutterPlugin {
    ...
    private let methodChannelName = "id.thunderlab.thuder_thermal_print/methods"
    private let connectionEventChannelName = "id.thunderlab.thuder_thermal_print/connection"
    private let deviceEventChannelName = "id.thunderlab.thuder_thermal_print/devices"
    private let dataEventChannelName = "id.thunderlab.thuder_thermal_print/data"
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let methodChannel = FlutterMethodChannel(
            name: "id.thunderlab.thuder_thermal_print",
            binaryMessenger: registrar.messenger()
        )

        // Event channels
        let connectionChannel = FlutterEventChannel(
            name: "id.thunderlab.thuder_thermal_print/connection",
            binaryMessenger: registrar.messenger()
        )
        let deviceChannel = FlutterEventChannel(
            name: "id.thunderlab.thuder_thermal_print/devices",
            binaryMessenger: registrar.messenger()
        )
        let dataChannel = FlutterEventChannel(
            name: "id.thunderlab.thuder_thermal_print/data",
            binaryMessenger: registrar.messenger()
        )
...
extension SwiftThuderThermalPrintPlugin: FlutterStreamHandler {
...
extension SwiftThuderThermalPrintPlugin: PrinterManagerDelegate {
