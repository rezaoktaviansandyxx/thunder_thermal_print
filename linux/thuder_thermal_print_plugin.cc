...
constexpr char kChannelName[] = "id.thunderlab.thuder_thermal_print";
...
// Plugin registration
// ---------------------------------------------------------------------------
void thuder_thermal_print_plugin_class_init(FluderThermalPrintPluginClass* klass) {}

void thuder_thermal_print_plugin_init(ThuderThermalPrintPlugin* self) {}

gboolean thuder_thermal_print_plugin_handle_method_call(
    ThuderThermalPrintPlugin* self,
    FlMethodCall* method_call) {
...
// C API
ThuderThermalPrintPlugin* thuder_thermal_print_plugin_new(
    FlPluginRegistrar* registrar) {
    g_autoptr(FlPluginRegistrar) reg = FL_PLUGIN_REGISTRAR(g_object_ref(registrar));
    ThuderThermalPrintPlugin* self = THUDER_THERMAL_PRINT_PLUGIN(
        g_object_new(thuder_thermal_print_plugin_get_type(), nullptr));
...
// GType boilerplate
G_DEFINE_TYPE(ThuderThermalPrintPlugin, thuder_thermal_print_plugin, g_object_get_type())

static void thuder_thermal_print_plugin_class_init(ThuderThermalPrintPluginClass* klass) {}

static void thuder_thermal_print_plugin_init(ThuderThermalPrintPlugin* self) {}

// Export the plugin
void thuder_thermal_print_plugin_register_with_registrar(
    FlPluginRegistrar* registrar) {
    thuder_thermal_print_plugin_new(registrar);
}
